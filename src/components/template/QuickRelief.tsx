...
import { ArrowRight, AlertTriangle, Clock, RefreshCw } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="bg-[#EAF4EE] rounded-[20px] p-8 flex flex-col justify-between transition-colors hover:bg-[#dfeee5]">
            ...
            <a
              ...
              className="btn-press w-full py-3 px-4 rounded-xl bg-[#173326] text-[#F7F5EF] font-medium text-[15px] hover:bg-[#2F5941] flex items-center justify-center gap-2 transition-colors"
            >
              <span>Zobrazit kompletní návod na strečink</span>
              <ArrowRight className="w-4 h-4" />
            </a>
          </div>

          {/* Block 2: Relief from Scapula pain */}
          <div className="bg-[#EAF4EE] rounded-[20px] p-8 flex flex-col justify-between transition-colors hover:bg-[#dfeee5]">
            <div>
              <div className="flex items-center justify-between mb-6">
                <span className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-[#2F5941] bg-[#F7F5EF] px-2.5 py-1 rounded-full border border-[#DDE5DD]">
            ...
            <a
              ...
              className="btn-press w-full py-3 px-4 rounded-xl bg-[#2F5941] text-[#F7F5EF] font-medium text-[15px] hover:bg-[#173326] flex items-center justify-center gap-2 transition-colors"
            >
          ...
          <div className="bg-[#FFF1E8] rounded-[20px] p-8 flex flex-col justify-between border-l-4 border-[#F2644B]">
            ...
            <a
              ...
              className="btn-press w-full py-3 px-4 rounded-xl border border-[#F2644B] text-[#F2644B] hover:bg-[#F2644B] hover:text-white font-medium text-[15px] flex items-center justify-center gap-2 transition-colors"
            >
