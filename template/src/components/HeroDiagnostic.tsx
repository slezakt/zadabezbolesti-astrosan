...
export const HeroDiagnostic: React.FC<HeroDiagnosticProps> = ({ onSelectPain }) => {
  // Map icons
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1">
                {DIAGNOSTIC_ITEMS.map((item) => (
                  <button
                    ...
                    aria-label={`Zobrazit pomoc pro: ${item.title}`}
                  >
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="relative w-full rounded-[24px] overflow-hidden bg-[#EAF4EE] border border-[#DDE5DD]">
              ...
              {/* Floating UI Elements (Clean paper background, ink text, no fake shadows) */}
              {/* Floating Badge 1: Eye level */}
              <div className="absolute top-8 left-6 sm:left-8 bg-[#F7F5EF] border border-[#DDE5DD] rounded-xl px-4 py-2.5 max-w-[210px]">
              ...
              {/* Floating Badge 2: Elbow 90 deg */}
              <div className="absolute bottom-8 right-6 sm:right-8 bg-[#F7F5EF] border border-[#DDE5DD] rounded-xl px-4 py-2.5 max-w-[210px]">
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full bg-[#F2644B]"></span>
