...
export const PopularArticles: React.FC<PopularArticlesProps> = ({ onOpenArticle }) => {
          ...
          <div className="lg:col-span-5 flex flex-col divide-y divide-[#DDE5DD] border-t border-b lg:border-t-0 border-[#DDE5DD]">
            {sideArticles.map((article) => (
              <button
                ...
                className="editorial-row group py-5 px-3 -mx-3 flex items-start justify-between text-left hover:bg-[#EAF4EE] rounded-lg transition-colors cursor-pointer focus:outline-none"
              >
